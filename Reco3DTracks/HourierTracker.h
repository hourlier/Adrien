/**
 * \file HourierTracker.h
 *
 * \ingroup Adrien
 *
 * \brief Class def header for a class HourierTracker
 *
 * @author kazuhiro
 */
...
#ifndef LARLITE_HOURIERTRACKER_H
#define LARLITE_HOURIERTRACKER_H
...
namespace larlite {
    /**
     \class HourierTracker
     User custom analysis class made by SHELL_USER_NAME
     */
    class HourierTracker : public ana_base{

    public:

        /// Default constructor
        HourierTracker(){ _name="HourierTracker"; _fout=0; _track_producer="dl"; _chstatus_producer="chstatus";_speedOffset=0;}

        /// Default destructor
        virtual ~HourierTracker(){}

        /** IMPLEMENT in HourierTracker.cc!
