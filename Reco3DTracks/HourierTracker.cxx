#ifndef LARLITE_HOURIERTRACKER_CXX
#define LARLITE_HOURIERTRACKER_CXX
...
namespace larlite {
    ...
    bool HourierTracker::initialize() {
        return true;
    }

    bool HourierTracker::analyze(storage_manager* storage) {
        gStyle->SetOptStat(0);
        //
    ...
    double HourierTracker::X2Tick(double x, size_t plane) const {
    ...
    larlite::track HourierTracker::Reconstruct(const TVector3& start_pt, const TVector3& end_pt,
                                               ...
                                               const std::vector<larcv::Image2D>& chstatus_image_v)
    {
        ...
        cOutput->SaveAs(Form("cOutput_%d_%d_%d_%d.png",_run,_subrun,_event,_track));
